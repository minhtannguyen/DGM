...
class NRM(nn.HybridBlock):
    def __init__(self, net_name, batch_size, num_class, use_bias=False, use_bn=False, do_topdown=False, do_countpath=False, do_pn=False, relu_td=False, do_nn=False, min_max=False):
        ...
        # make layers
        self.features, self.features_min, layers_drm, layers_drm_cp = self._make_layers(cfg[net_name], use_bias, use_bn, self.do_topdown, self.do_countpath, self.min_max)
        with self.name_scope():
